...
const plugins = (dev = false, beta = false) => {
  ...
  return [
    //we want sourcemaps to be generated by devtool for prod-beta branch
    ...(process.env.SOURCEMAPS === 'true' && process.env.BRANCH !== 'prod-beta'
      ? [
