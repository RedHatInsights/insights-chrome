...
const plugins = (dev = false) => [
  ...
  new ModuleFederationPlugin({
    ...
    shared: [
      ...
      { 'react-redux': { requiredVersion: deps['react-redux'], eager: true } },
      { '@patternfly/react-table': { requiredVersion: deps['@patternfly/react-table'], eager: true } },
      { '@patternfly/react-core': { requiredVersion: deps['@patternfly/react-core'], eager: true } },
      { '@patternfly/quickstarts': { singleton: true, requiredVersion: deps['@patternfly/quickstarts'], eager: true } },
      { '@scalprum/react-core': { singleton: true, requiredVersion: deps['@scalprum/react-core'], eager: true } },
      { '@unleash/proxy-client-react': { singleton: true, requiredVersion: deps['@unleash/proxy-client-react'], eager: true } },
    ],
  }),
  ChunkMapper,
