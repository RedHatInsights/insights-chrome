              ...
              <Switch
                ...
                label={
                  <Text className="pf-v5-u-color-100" component={TextVariants.small}>
                    You&apos;re in Hybrid Cloud Console Preview mode. To return to production, turn off Preview mode
                  </Text>
                }
                labelOff={
                  <Text className="pf-v5-u-color-light-100" component={TextVariants.small}>
                    You&apos;re in Hybrid Cloud Console production. To see new pre-production features, turn on Preview mode
                  </Text>
                }
