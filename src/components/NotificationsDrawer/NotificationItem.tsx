...
const NotificationItem = ({ notifications }: { notifications: Notifications["data"] }) => {
  const [isDropdownOpen, setIsDropdownOpen] = useState(false);
  const [isNotificationRead, setIsNotificationRead] = useState(false);
  console.log('This is my current notification item: ', notifications);
  ...
  return (
    <React.Fragment>
      {notifications.map(( notification, index ) => (
        <NotificationDrawerList key={index}>
          <NotificationDrawerListItem 
            variant="info"
