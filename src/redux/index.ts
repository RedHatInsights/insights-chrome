...
import {
  ...
  MARK_ACTIVE_PRODUCT,
  MARK_NOTIFICATION_AS_DESELECTED,
  MARK_NOTIFICATION_AS_READ,
  MARK_NOTIFICATION_AS_SELECTED,
...
const reducers = {
  ...
  [MARK_NOTIFICATION_AS_SELECTED]: markNotificationsAsSelected,
  [MARK_NOTIFICATION_AS_DESELECTED]: markNotificationsAsDeselected,
  [SELECT_ALL_NOTIFICATIONS]: selectAllNotifications,
  [DESELECT_ALL_NOTIFICATIONS]: deselectAllNotifications,
  [MARK_SELECTED_NOTIFICATIONS_AS_READ]: markSelectedNotificationsAsRead,
  [MARK_SELECTED_NOTIFICATIONS_AS_UNREAD]: markSelectedNotificationsAsUnread,
